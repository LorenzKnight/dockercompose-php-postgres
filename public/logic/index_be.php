...
//             $LoginRS__query=sprintf("SELECT user_id, email, password, rank FROM users WHERE email=%s AND password=%s AND status=1",
...
//                 $_SESSION['tks_UserId'] = mysqli_result($LoginRS,0,'user_id');
